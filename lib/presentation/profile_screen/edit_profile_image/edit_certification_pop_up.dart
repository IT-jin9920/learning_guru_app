...
class EditCertificationPopUp extends StatefulWidget {
  const EditCertificationPopUp({super.key});

  @override
  State<EditCertificationPopUp> createState() => _EditCertificationPopUpState();
}

class _EditCertificationPopUpState extends State<EditCertificationPopUp> {
