...
import 'package:learning_guru_app/presentation/profile_screen/edit_profile_image/edit_profile_image.dart';
...
class ProfileDetailsTutors extends StatefulWidget {
  const ProfileDetailsTutors({super.key});

  @override
  State<ProfileDetailsTutors> createState() => _ProfileDetailsTutorsState();
}

class _ProfileDetailsTutorsState extends State<ProfileDetailsTutors> {
  File? _imageFile;
