...
class _StudentSearchScreenState extends State<StudentSearchScreen> {
  ...
  final List<String> tabs = ["Community", "Mentors", "Learning"];
      ...
      itemBuilder: (_, index) {
        ...
        return Padding(
          ...
          child: Row(
            children: [
              _buildUserCard(
                name: items[firstIndex], // 1st item
                subject: 'Maths',
                rate: '4.8',
              ...
              if (secondIndex < items.length) // check if 2nd card exists
                _buildUserCard(
                  name: items[secondIndex], // 2nd item
                  subject: 'Science',
                  rate: '4.6',
                  imagePath: 'user-2.png',
                )
              else
                const SizedBox(width: 158), // empty placeholder to align
            ],
          ),
        );
      },
  ...
  Widget _buildUserCard({
    ...
    return GestureDetector(
      onTap: () {
       ...
       // bottomNavController.changeTab(4); // Redirect to Profile
       // Get.back(); // Optional: Close SearchScreen
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            UIHelper.boldText(text: "\$",  fontSize: 14, color:AppColors.primary2),
                            UIHelper.boldText(text: "10 / Hr", fontSize: 12, color:AppColors.white),
                          ],
                        ),
                      ),
                    ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      UIHelper.customSvg(svg: "subject-svg.svg",width: 16, height: 16),
                      SizedBox(width: 4,),
                      UIHelper.boldText(
                        text: subject,
                        fontSize: 14,
                  ...
                  Row(
                    children: [
                      UIHelper.customSvg(svg: "star-svg-icon.svg", height: 16, width: 16),
                      const SizedBox(width: 4),
                      UIHelper.mediumText(
                        text:rate,
                        fontSize: 12,
