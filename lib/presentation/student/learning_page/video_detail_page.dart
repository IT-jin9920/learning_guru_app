...
class StudentVideoDetailPage extends StatefulWidget {
  const StudentVideoDetailPage({super.key});

  @override
  State<StudentVideoDetailPage> createState() => _StudentVideoDetailPageState();
}

class _StudentVideoDetailPageState extends State<StudentVideoDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Theme(
              ...
              child: ExpansionTile(
                ...
                children: [
                  ...
                  lessonTile(
                    "Blender 4.2 Updates - Ao & Screen Space Reflections",
                    "20:00",
                  ),
                  ...
                  lessonTile(
                    "Detailed Steps for the Software workspace setup",
                    "5 min Read",
                  ),
                ],
              ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  includeTile(
                    "time-icon-svg.svg",
                    "120Hr Total to complete the course",
                  ),
                  SizedBox(height: 18),
      ...
      bottomNavigationBar: Padding(
        ...
        child: GradientButton(text: "Buy Now", onTap: () {}),
      ),
    );
  }
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          UIHelper.regularText(
                            text:
                                'Are you really want to delete your Uploaded Course? that will complete remove all course data.',
                            fontSize: 14,
                            color: AppColors.grey,
                            textAlign: TextAlign.center,
                          ),
