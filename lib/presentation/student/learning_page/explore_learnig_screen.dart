...
class ExploreLearnigScreen extends StatefulWidget {
  const ExploreLearnigScreen({super.key});

  @override
  State<ExploreLearnigScreen> createState() => _ExploreLearnigScreenState();
}

class _ExploreLearnigScreenState extends State<ExploreLearnigScreen> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Subtitle
                  UIHelper.mediumText(
                    text: 'We will personalise your learning experience based on the Categories you prefer.',
                    fontSize: 14,
                    color: Colors.grey,
